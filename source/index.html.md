...
|	interval	|	string	|	TRUE	|	K线间隔	|	1m,5m,15m,30m,60m,4h,1d（基于自然日，新加坡时间）,1w（基于自然周，新加坡时间）,1M（基于自然月，新加坡时间）,1y（基于自然年，新加坡时间）	|		|
