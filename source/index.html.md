...
- Besides the above two rest interfaces, for getting the infomation that system maintenance with service suspended, could by subscrib system status updates websocket interface（<a href='https://docs.huobigroup.com/docs/coin_margined_swap/v1/en/#subscribe-system-status-updates'>Subscribe system status updates</a>）
