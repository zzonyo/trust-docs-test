...
## 1.1.2 2020年4月9日预上线 【增加：增加免鉴权的强平订单WS推送接口】
...
一、温馨提示您，交割合约在新加坡时间每周五16:00进行结算。在结算期间查询资金和持仓会返回错误码，返回的错误码及错误码表示的含义如下：
...
| topic | true| string | 订阅主题名称，必填 (public.$symbol.liquidation_orders) 订阅某个品种下的强平订单信息；$symbol为品种代码（BTC、ETH），如果值为 * 时代表订阅所有品种; | |
