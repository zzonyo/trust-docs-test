...
| etf | etf-subscription-apply-transfer | 用户suspense账户转到系统ETF账户
...
| etf | etf-purchase-apply-transfer | 用户suspense账户转到系统ETF账户
| etf | etf-purchase-settle-transfer | 系统ETF账户转到用户trade账户
| etf | etf-redemption-cancel | 系统ETF账户转到用户trade账户
| etf | etf-redemption-apply-transfer | 用户suspense账户转到系统ETF账户
| etf | etf-redemption-settle-transfer | 系统ETF账户转到用户trade账户
...
| transfer | futures-transfer-in | 转账划入futures
| transfer | futures-transfer-in-v2 | 转账划入futures
| transfer | futures-transfer-out | 转账划出futures
| transfer | futures-transfer-out-v2 | 转账划出futures
...
| transfer | swap-transfer-in | 转账划入swap
| transfer | swap-transfer-out | 转账划出swap
| transfer | dm-swap-transfer-in | 转账划入dm-swap
| transfer | dm-swap-transfer-out | 转账划出dm-swap
| transfer | option-transfer-in | 转账划入option
| transfer | option-transfer-out | 转账划出option
| transfer | cfd-transfer-in | 转账划入cfd
| transfer | cfd-transfer-out | 转账划出cfd
...
| transfer | linear-swap-transfer-in | 转账划入LINEAR-SWAP
| transfer | linear-swap-transfer-out | 转账划出LINEAR-SWAP
...
| transfer | otc-generic-transfer-in | otc 通用划转划入
| transfer | otc-generic-transfer-out | otc 通用划转转出
| transfer | spot-generic-transfer-in | SPOT 通用划转划入
| transfer | spot-generic-transfer-out | SPOT 通用划转转出
| transfer | margin-generic-transfer-in | MARGIN 通用划转划入
| transfer | margin-generic-transfer-out | MARGIN 通用划转转出
| transfer | point-generic-transfer-in | POINT 通用划转划入
| transfer | point-generic-transfer-out | POINT 通用划转转出
| transfer | minepool-generic-transfer-in | MINEPOOL 通用划转划入
| transfer | minepool-generic-transfer-out | MINEPOOL 通用划转转出
| transfer | super-margin-generic-transfer-in | SUPER_MARGIN 通用划转划入
| transfer | super-margin-generic-transfer-out | SUPER_MARGIN 通用划转转出
| transfer | investment-generic-transfer-in | INVESTMENT 通用划转划入
| transfer | investment-generic-transfer-out | INVESTMENT 通用划转转出
| transfer | borrow-generic-transfer-in | BORROW 通用划转划入
| transfer | borrow-generic-transfer-out | BORROW 通用划转转出
| transfer | deposit-earning-generic-transfer-in | DEPOSIT_EARNING 通用划转划入
| transfer | deposit-earning-generic-transfer-out | DEPOSIT_EARNING 通用划转转出
| transfer | crypto-loans-generic-transfer-in | CRYPTO_LOANS 通用划转划入
| transfer | crypto-loans-generic-transfer-out | CRYPTO_LOANS 通用划转转出
| transfer | grid-trading-generic-transfer-in | GRID_TRADING 通用划转划入
| transfer | grid-trading-generic-transfer-out | GRID_TRADING 通用划转转出
...
| deposit | user-credit-loan-to-system | 用户撤销充值，欠费(trade)账户转账到系统账户
