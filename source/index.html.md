...
* 普通用户，需要密钥的私有接口，每个UID 3秒最多62次请求(交易接口3秒最多31次请求，查询接口3秒最多31次请求) (该UID的所有币种和不同到期日的合约的所有私有接口共享该限制) <a href=https://docs.huobigroup.com/docs/dm/v1/cn/#ab0b26742c>查看API接口类型列表(其中读取即查询,交易即交易)</a>  
